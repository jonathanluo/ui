...
//  image = gtk_image_new_from_file ("/home/moonwave/workspace/github/jon/ui/cgtk3/resource/gnome-fs-directory.png");//ok
  image = gtk_image_new_from_file ("./resource/gnome-fs-directory.png");//ok
